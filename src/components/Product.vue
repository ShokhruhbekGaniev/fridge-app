<template>
    <div class="component-product" :title="product.name" @click.stop="viewProduct(product)">
        ...
        <button
            class="bg-button-blue hover:bg-button-blue text-white py-1 px-2 rounded-2xl mt-2"
            @click="() => isOpen = true"
        >
            Информация
        </button>
        <button
            class="bg-button-grey hover:bg-button-grey text-delete-button py-1 px-2 rounded-2xl mt-2 font-bold" 
        ...
        <div class="info " :class="{'active': isOpen}">
            <div class="w-full flex justify-end">
                <div class="times" @click="() => isOpen = false">&#215;</div>
            </div>
